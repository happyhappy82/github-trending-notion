"""Ars Technica AI RSS Feed → Notion DB 자동 수집기

Ars Technica AI 카테고리 RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_arstechnica_ai.json"

RSS_FEEDS = [
    {
        "url": "https://arstechnica.com/ai/feed/",
        "source_type": "Ars Technica AI",
    },
]
...
def fetch_rss(feed_url):
    ...
    headers = {"User-Agent": "Mozilla/5.0 (compatible; ArsTechnicaAIBot/1.0)"}
