"""Wired AI RSS Feed → Notion DB 자동 수집기

Wired AI 태그 RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_wired_ai.json"

RSS_FEEDS = [
    {
        "url": "https://www.wired.com/feed/tag/ai/latest/rss",
        "source_type": "Wired AI",
    },
]
...
def fetch_rss(feed_url):
    ...
    headers = {"User-Agent": "Mozilla/5.0 (compatible; WiredAIBot/1.0)"}
