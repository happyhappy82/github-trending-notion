"""Stability AI News RSS Feed → Notion DB 자동 수집기

Stability AI 뉴스 RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_stability_ai.json"

RSS_FEEDS = [
    {
        "url": "https://stability.ai/news?format=rss",
        "source_type": "Stability AI",
    },
]
...
def fetch_rss(feed_url):
    ...
    headers = {"User-Agent": "Mozilla/5.0 (compatible; StabilityAIBot/1.0)"}
