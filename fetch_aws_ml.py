"""AWS Machine Learning Blog → Notion DB 자동 수집기

AWS Machine Learning 블로그 RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_aws_ml.json"

RSS_FEEDS = [
    {"url": "https://aws.amazon.com/blogs/machine-learning/feed/", "source_type": "AWS ML Blog"},
]


def fetch_rss(feed_url):
    """RSS 피드를 파싱하여 아이템 목록을 반환한다."""
    headers = {"User-Agent": "Mozilla/5.0 (compatible; AWSMLBot/1.0)"}
