"""The Verge AI RSS Feed → Notion DB 자동 수집기

The Verge AI 카테고리 RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_verge_ai.json"

RSS_FEEDS = [
    {
        "url": "https://www.theverge.com/rss/ai-artificial-intelligence/index.xml",
        "source_type": "The Verge AI",
    },
]
...
def fetch_rss(feed_url):
    ...
    headers = {"User-Agent": "Mozilla/5.0 (compatible; VergeAIBot/1.0)"}
