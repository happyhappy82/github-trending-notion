"""MIT Technology Review AI RSS Feed → Notion DB 자동 수집기

MIT Technology Review AI 토픽 RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_mit_tech_review.json"

RSS_FEEDS = [
    {
        "url": "https://www.technologyreview.com/topic/artificial-intelligence/feed/",
        "source_type": "MIT Tech Review",
    },
]
...
def fetch_rss(feed_url):
    ...
    headers = {"User-Agent": "Mozilla/5.0 (compatible; MITTechReviewBot/1.0)"}
