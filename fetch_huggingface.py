"""Hugging Face Blog RSS Feed → Notion DB 자동 수집기

Hugging Face 공식 블로그 RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_huggingface.json"

RSS_FEEDS = [
    {
        "url": "https://huggingface.co/blog/feed.xml",
        "source_type": "Hugging Face Blog",
    },
]
...
def fetch_rss(feed_url):
    ...
    headers = {"User-Agent": "Mozilla/5.0 (compatible; HuggingFaceBot/1.0)"}
