"""VentureBeat AI RSS Feed → Notion DB 자동 수집기

VentureBeat AI 카테고리 RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_venturebeat_ai.json"

RSS_FEEDS = [
    {
        "url": "https://venturebeat.com/category/ai/feed/",
        "source_type": "VentureBeat AI",
    },
]
...
def fetch_rss(feed_url):
    ...
    headers = {"User-Agent": "Mozilla/5.0 (compatible; VentureBeatAIBot/1.0)"}
