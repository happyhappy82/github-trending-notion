"""Google AI Blog → Notion DB 자동 수집기

Google AI 관련 블로그 RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_google_ai.json"

RSS_FEEDS = [
    {
        "url": "https://deepmind.google/blog/feed/",
        "source_type": "Google DeepMind",
    },
    {
        "url": "https://blog.google/technology/ai/rss/",
        "source_type": "Google AI Blog",
    },
    {
        "url": "https://research.google/blog/rss/",
        "source_type": "Google Research",
    },
    {
...
def fetch_rss(feed_url):
    ...
    headers = {"User-Agent": "Mozilla/5.0 (compatible; GoogleAIBot/1.0)"}
