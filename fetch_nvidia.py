"""NVIDIA Blog → Notion DB 자동 수집기

NVIDIA 블로그 RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_nvidia.json"

RSS_FEEDS = [
    {"url": "https://blogs.nvidia.com/feed/", "source_type": "NVIDIA Blog"},
]


def fetch_rss(feed_url):
    """RSS 피드를 파싱하여 아이템 목록을 반환한다."""
    headers = {"User-Agent": "Mozilla/5.0 (compatible; NVIDIABot/1.0)"}
