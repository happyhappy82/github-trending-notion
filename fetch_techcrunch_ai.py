"""TechCrunch AI RSS Feed → Notion DB 자동 수집기

TechCrunch AI 카테고리 RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_techcrunch_ai.json"

RSS_FEEDS = [
    {
        "url": "https://techcrunch.com/category/artificial-intelligence/feed/",
        "source_type": "TechCrunch AI",
    },
]
...
def fetch_rss(feed_url):
    ...
    headers = {"User-Agent": "Mozilla/5.0 (compatible; TechCrunchAIBot/1.0)"}
