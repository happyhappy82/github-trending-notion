"""OpenAI Blog RSS Feed → Notion DB 자동 수집기

OpenAI 공식 블로그/뉴스 RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_openai_blog.json"
...
def fetch_rss(feed_url):
    ...
    headers = {"User-Agent": "Mozilla/5.0 (compatible; OpenAIBlogBot/1.0)"}
