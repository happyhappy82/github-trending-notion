"""Apple Machine Learning → Notion DB 자동 수집기

Apple Machine Learning Research RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_apple_ml.json"

RSS_FEEDS = [
    {"url": "https://machinelearning.apple.com/rss.xml", "source_type": "Apple ML Research"},
]


def fetch_rss(feed_url):
    """RSS 피드를 파싱하여 아이템 목록을 반환한다."""
    headers = {"User-Agent": "Mozilla/5.0 (compatible; AppleMLBot/1.0)"}
