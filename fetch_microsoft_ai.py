"""Microsoft AI Blog → Notion DB 자동 수집기

Microsoft AI 관련 블로그 RSS 피드를 수집한다.
"""
...
SEEN_FILE = Path(__file__).parent / "seen_microsoft_ai.json"

RSS_FEEDS = [
    {"url": "https://news.microsoft.com/source/feed/", "source_type": "Microsoft AI News"},
    {"url": "https://www.microsoft.com/en-us/research/feed/", "source_type": "Microsoft Research"},
]


def fetch_rss(feed_url):
    """RSS 피드를 파싱하여 아이템 목록을 반환한다."""
    headers = {"User-Agent": "Mozilla/5.0 (compatible; MicrosoftAIBot/1.0)"}
